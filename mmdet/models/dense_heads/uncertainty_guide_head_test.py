...
class UncertaintyGuideHeadTest(AnchorHead):
    ...
    def __init__(self,
        ...
        super(UncertaintyGuideHeadTest, self).__init__(num_classes, in_channels, **kwargs)
        ...
        self.loss_uncertainty = build_loss(dict(type='UncertaintyLoss', loss_weight=0.001))
    ...
    def forward_single(self, x, scale):
        ...
        cls_score = self.gfl_cls(cls_feat).sigmoid()              ##### J = C x I
        ...
        return cls_score, bbox_pred, uncertainty                                           
    ...
    @force_fp32(apply_to=('cls_scores', 'bbox_preds', 'bbox_offsets', 'uncertainty'))
    def loss(self,
             cls_scores,
             bbox_preds,
            #  bbox_offsets,   #####
    ...
    @force_fp32(apply_to=('cls_scores', 'bbox_preds', 'uncertainty'))
    def get_bboxes(self,
                   cls_scores,
                   bbox_preds,
                #    bbox_offsets,
